...
func TestSTLStyler(t *testing.T) {
	...
	s.boxing = astikit.BoolPtr(true)
	s.update(sa)
	assert.Equal(t, StyleAttributes{STLStyleAttributes: STLStyleAttributes{STLBoxing: s.boxing}}, *sa)
	s.italics = astikit.BoolPtr(true)
	s.update(sa)
	assert.Equal(t, StyleAttributes{STLStyleAttributes: STLStyleAttributes{STLBoxing: s.boxing, STLItalics: s.italics}}, *sa)
	s.underline = astikit.BoolPtr(true)
	s.update(sa)
	assert.Equal(t, StyleAttributes{STLStyleAttributes: STLStyleAttributes{STLBoxing: s.boxing, STLItalics: s.italics, STLUnderline: s.underline}}, *sa)
}
